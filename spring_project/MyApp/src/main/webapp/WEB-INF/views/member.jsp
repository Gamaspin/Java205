...
<script>
	$(document).ready(function(){
		...
		$('#memberid').focusout(function() {
			...
			$.ajax({
				url : 'http://3.35.13.42:8080/op/member/idCheck',
				type : 'post',
				data : {
					mid : $(this).val()
				},
	...
	function memberList(){
		$.ajax({
			url : 'http://3.35.13.42/:8080/op/members',
			type : 'GET',
			success : function(data){
				console.log(data);
				$.each(data, function(index, item){
					...
					html += '사진 : <img src="http://3.35.13.42:8080/op/uploadfile/' + item.memberphoto + '"><br>';
			...
			<table>
				<tr>
					...
					<td><input type="text" name="memberid" id="memberid">
						...
						src="http://3.35.13.42:8080/op/images/loading.gif">
						</td>
				</tr>
				<tr>
					<td>비밀번호</td>
