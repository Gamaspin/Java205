...
//
//				List<Class> list = dao.getClassList(conn);
//
//				System.out.println("강좌 정보 리스트");
//				System.out.println("-----------------------------");
//				System.out.println("1. 분류별 보기");
//				System.out.println("2. 할인중인 강좌 보기");
//				System.out.println("3. 마감 임박 강좌 보기");
//				System.out.println("4. 주변 지역 강좌 보기");
//				System.out.println("-----------------------------");
//
//				for (Class class : list) {
//					System.out.printf("%d \t %s \t %s \n", class.getDeptno(), dept.getDname(), dept.getLoc());
//				}
//
//				System.out.println("-----------------------------");
//
